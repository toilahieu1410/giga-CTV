          ...
          <View style={styles.groupOrder}>
            <View style={[styles.itemOrder,{width: (widthLayout - moderateScale(20)) }]}>
              <View style={styles.flexRow}>
                <Text style={styles.shippingNameDraft4}>{item.shipping_name}</Text>
                <TouchableOpacity style={styles.btnShowDetail4}>
                  <Text style={styles.btnShowDetailText}>Mua lại</Text>
                </TouchableOpacity>
              </View>
